...
def parse_args():
    ...
    parser.add_argument("--input_file", type=str,default="/inspire/ssd/project/sais-bio/public/lijiaye/t2av/self-forcing/audiobox-aesthetics/input.jsonl")
...
def app():
    ...
    fn_wrapped = partial(main_predict, batch_size=args.batch_size, ckpt="/inspire/ssd/project/sais-bio/public/lijiaye/t2av/self-forcing/ckpt/checkpoint.pt")
