    ...
    def __init__(
        ...
        *,
        ...
        if data_dim == 80:
            ...
            self.data_mean = nn.Buffer(
                torch.tensor(DATA_MEAN_128D, dtype=torch.float32)
            )
...
class Encoder1D(nn.Module):
    def __init__(
        ...
        *,
        ...
        # end
        self.conv_out = MPConv1D(
            block_in, 2 * embed_dim if double_z else embed_dim, kernel_size=kernel_size
        )
